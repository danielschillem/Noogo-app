...
[ -n "$FILESYSTEM_DISK" ]   && echo "FILESYSTEM_DISK=$FILESYSTEM_DISK" >> "$ENV_FILE"

# Cloudflare R2 (S3-compatible object storage)
[ -n "$CLOUDFLARE_R2_ACCESS_KEY_ID" ] && echo "CLOUDFLARE_R2_ACCESS_KEY_ID=$CLOUDFLARE_R2_ACCESS_KEY_ID" >> "$ENV_FILE"
[ -n "$CLOUDFLARE_R2_SECRET_ACCESS_KEY" ] && echo "CLOUDFLARE_R2_SECRET_ACCESS_KEY=$CLOUDFLARE_R2_SECRET_ACCESS_KEY" >> "$ENV_FILE"
[ -n "$CLOUDFLARE_R2_BUCKET" ] && echo "CLOUDFLARE_R2_BUCKET=$CLOUDFLARE_R2_BUCKET" >> "$ENV_FILE"
[ -n "$CLOUDFLARE_R2_ENDPOINT" ] && echo "CLOUDFLARE_R2_ENDPOINT=$CLOUDFLARE_R2_ENDPOINT" >> "$ENV_FILE"
[ -n "$CLOUDFLARE_R2_PUBLIC_URL" ] && echo "CLOUDFLARE_R2_PUBLIC_URL=$CLOUDFLARE_R2_PUBLIC_URL" >> "$ENV_FILE"
...
php artisan route:list --path=api/health 1>/dev/null
